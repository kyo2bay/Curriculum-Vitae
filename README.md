...
|Address|東京都 新宿区|
|Education|京都大学 総合人間学部卒業 <br> Foothill College Computer Science 中退|
|Qiita|https://qiita.com/kyo2bay
|LinkedIn|https://www.linkedin.com/in/kyo2bay

## 概要
- クラウドアーキテクチャ設計、DWH基盤コード開発の経験が豊富です。
- 保守改修よりは新規開発の業務の経験の方が多く、上流下流問わずゼロからの設計が可能です。
...
## スキル
### 言語（得意順）
Golang | Python | Java | Ruby | Bash Script
